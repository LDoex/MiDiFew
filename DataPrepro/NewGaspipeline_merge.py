...
File_names = {str(i): os.path.join('./csvData/New_Gaspipeline_'+str(i)+'.csv') for i in range(8)}
TrainOutput_path = os.path.join('./csvData/New_Gaspipeline_Train.csv')
TestOutput_path = os.path.join('./csvData/New_Gaspipeline_Test.csv')
