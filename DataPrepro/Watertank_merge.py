...
File_names = {str(i): os.path.join('./csvData/Watertank_'+str(i)+'.csv') for i in range(8)}
TrainOutput_path = os.path.join('./csvData/Watertank_Train.csv')
TestOutput_path = os.path.join('./csvData/Watertank_Test.csv')
