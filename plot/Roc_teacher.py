...
# #
# vars.setName('re_file7', os.path.join('./', 'y_real_preteacher_kdd.csv'))
# vars.setName('preProb_file7', os.path.join('./', 'decision_val_preteacher_kdd.csv'))
#
...
names = ['ideal_teacher', 'ideal_student', 'globalteacherFT', 'client1Teacher',  'client1student',
         'client1_studentKD', 'pt_kdd', 'client2',  'client3FT',  'client3',  'client4FT',  'client4']
