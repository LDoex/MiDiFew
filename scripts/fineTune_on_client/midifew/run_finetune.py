...
#input model
default_model_path = '../../results/best_preteacher_kdd.pt'
...
#best_model_name
default_best_name = 'best_teacherFT'
...
parser.add_argument('--train.learning_rate', type=float, default=1e-1, metavar='LR',
