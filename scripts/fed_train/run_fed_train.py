...
# train args
parser.add_argument('--train.epochs', type=int, default=3, metavar='NEPOCHS',
...
parser.add_argument('--train.learning_rate', type=float, default=0.08, metavar='LR',
                    help='learning rate (default: 0.0001)')
parser.add_argument('--train.decay_every', type=int, default=5, metavar='LRDECAY',
...
parser.add_argument('--fed.comm_num', type=int, default=100, metavar='NCOMMUNICATION',
...
default_global_model_path = '../../scripts/fed_train/results'
...
parser.add_argument('--fed.test_episodes', type=int, default=50, metavar='NTEST',
                    help="number of test episodes per epoch (default: 100)")
