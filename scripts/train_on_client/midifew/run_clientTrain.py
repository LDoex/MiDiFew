...
# model args
default_model_name = 'midifew_student_conv2d'
...
#client_name
client_name = 'client1'
parser.add_argument('--train.clientName', type=str, default=client_name, metavar='CLIENTNAME',
                    help="model name (default: {:s})".format(client_name))
...
#best_model_name
default_best_name = 'best_student'
...
parser.add_argument('--train.learning_rate', type=float, default=1e-3, metavar='LR',
