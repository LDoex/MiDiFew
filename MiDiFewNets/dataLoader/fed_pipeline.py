...
def load_class_data(dataset, client_name, d):
    alphabet = d['class']
    data_dir = os.path.join(DATA_DIR, dataset, client_name, alphabet, alphabet+'.csv')
...
def load(opt, splits, client_name):
    ...
    for split in  splits:
        ...
        transforms = [partial(convert_dict, 'class'),
                      partial(load_class_data, opt['data.dataset'], client_name),
